-- Fills the host agreement's party details from the GST registration
-- (Form GST REG-06, GSTIN 09EANPG5213E1ZT) and names Sambhal, Uttar Pradesh as
-- the seat of arbitration and the forum for jurisdiction.
--
-- The previous version left these as [[PLACEHOLDERS]]. A host signing a
-- contract whose counterparty is a blank has signed nothing useful, and a
-- payment gateway reviewing the agreement reads placeholders as an unfinished
-- document — so they are filled here rather than left for someone to remember.
--
-- "Principal place of business" rather than "registered office": the entity is
-- a proprietorship, which has no registered office, and that is the term the
-- GST certificate itself uses.
...
- This Host Agreement ("Agreement") is entered into between Shubh Gupta, sole proprietor trading as Shubh Traders (GSTIN 09EANPG5213E1ZT, PAN EANPG5213E), having its principal place of business at Gate No. 2, Balaji Mandir Road, Near Balaji Mandir, Hallu Sarai, Sambhal, District Sambhal, Uttar Pradesh 244302, India, which operates the Baagly platform at www.baagly.com ("Platform", "we", "us"), and the individual or entity listing a property through it ("Host", "you").
...
- The parties will first attempt to resolve any dispute in good faith. A dispute not resolved within thirty (30) days will be referred to arbitration by a sole arbitrator under the Arbitration and Conciliation Act, 1996. The seat and venue of arbitration is Sambhal, Uttar Pradesh, India, and the language is English.
- Subject to arbitration, the courts at Sambhal, Uttar Pradesh, India have exclusive jurisdiction.

## 20. Notices
- Notices to you are sent to the email address on your account and are treated as received on the day of sending.
- Notices to the Platform are sent to info@baagly.com and to the principal place of business in clause 1.
