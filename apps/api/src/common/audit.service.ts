...
export const AuditActions = {
  ...
  PROPERTY_TRUSTED: 'PROPERTY_TRUSTED',
  PROPERTY_UNTRUSTED: 'PROPERTY_UNTRUSTED',
  HOST_AGREEMENT_PUBLISHED: 'HOST_AGREEMENT_PUBLISHED',
  HOST_AGREEMENT_SIGNED: 'HOST_AGREEMENT_SIGNED',
  HOST_PHONE_VERIFIED: 'HOST_PHONE_VERIFIED',
  USER_PHONE_VERIFIED: 'USER_PHONE_VERIFIED',
  HOST_KYC_SUBMITTED: 'HOST_KYC_SUBMITTED',
  HOST_KYC_REVIEWED: 'HOST_KYC_REVIEWED',
  HOST_BANK_ACCOUNT_SAVED: 'HOST_BANK_ACCOUNT_SAVED',
